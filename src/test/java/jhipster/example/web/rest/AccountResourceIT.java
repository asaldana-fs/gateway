...
import static jhipster.example.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import java.time.Instant;
import java.util.*;
import jhipster.example.IntegrationTest;
import jhipster.example.config.Constants;
import jhipster.example.domain.User;
import jhipster.example.repository.AuthorityRepository;
import jhipster.example.repository.UserRepository;
import jhipster.example.security.AuthoritiesConstants;
import jhipster.example.service.UserService;
import jhipster.example.service.dto.AdminUserDTO;
import jhipster.example.service.dto.PasswordChangeDTO;
import jhipster.example.service.dto.UserDTO;
import jhipster.example.web.rest.vm.KeyAndPasswordVM;
import jhipster.example.web.rest.vm.ManagedUserVM;
